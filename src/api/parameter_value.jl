...
_parse_db_value(value, ::Val{:float}) = _parse_db_value(value)
_parse_db_value(value, ::Val{:str}) = _parse_db_value(value)
_parse_db_value(value, ::Val{:bool}) = _parse_db_value(value)
