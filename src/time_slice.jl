...
# FIXME: `Base.in` determines whether an item is in the given collection,
# in the sense that it is == to one of the values generated by iterating over the collection.
# This should be called `iscontained`
"""
