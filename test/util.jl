...
@testset "object_class_to_dict" begin
    ...
    add_parameter_value!(graph, :cat, :age, parameter_value(1), :silvester)
    add_parameter_value!(graph, :cat, :age, parameter_value(2), :tom)
...
@testset "relationship_class_to_dict" begin
    ...
    add_parameter_value!(graph, :cat__cat__dog, :aver_age, parameter_value(1), :cat => :silvester, :cat => :tom, :dog => :pluto)
    add_parameter_value!(graph, :cat__cat__dog, :aver_age, parameter_value(2), :cat => :tom, :cat => :silvester, :dog => :pluto)
