...
function _test_superclasses()
    @testset "superclasses" begin
        ...
        =#
        #TODO Add unit tests for the autogenerated subclasses!
    end
end
...
function _test_reorder_dimensions()
    @testset "reorder_dimensions" begin
        ...
        # TODO: ONKO TÄSSÄ ITSE ASIASSA MITÄÄN MIELTÄ?
        # Vaikka luokat saa helposti muokattua uuteen uskoon,
        # Parametrikutsujen mappays vaatii kuitenkin vielä säätöä.
        # Sen voi toki myös automatisoida, mutta oltava todella varovainen
        # ettei luoda helvetisti turhia luokkia prosessoinnin eri vaiheissa
        # viemään keskusmuistia ja tukkimaan garbage collectionia...
    end
end
