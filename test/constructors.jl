...
@testset "constructors" begin
    ...
    @test_throws ErrorException("invalid lower bound x.") SpineInterface._parse_time_period("Mx-4")
    @test_throws ErrorException("invalid upper bound x.") SpineInterface._parse_time_period("M5-x")
end
